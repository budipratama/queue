...
Class Queue{
	...
	protected 	$serv_time 			= 4; # mendefinisikan serv time dengan nilai 4 INT
	protected 	$time_of_arrival 	= 0; # mendefinisikan time of arrivel dengan nilai 0 INT
	protected 	$start_service		= 0; # mendefinisikan start time pertama dengan nilai 0 INT
	protected 	$end_service 		= 0; # mendefinisikan send service pertama dengan nilai 0 INT
	protected 	$int_arrv_time; 		 # mendefinisikan interval arrival time array
	protected 	$time_in_queue 		= 0; # mendefinisikan interval arrival time array
	protected 	$operation_time		= 0; # mendefinisikan opertation time dengan nilai 0 INT
	protected 	$avgTimeInQueue     = 0; # mendefinisikan average time in queue dengan nilai 0 INT
	protected 	$total 				= 0; # mendefinisikan total dengan nilai 0 INT
	protected   $total_time_in_queue = 0; # mendefinisikan total time in queue dengan nilai 0 INT

	/**
	* Saat membuat objec harus menyertakan parameter antrian dengan bentuk array numerik
	*
	*	
	*/
	...
	* setTimeInQueue 
	*
	* untuk set nilai time_in_queue 
	*
	* @param $val INT akumulasi time_in_queue 
	*/
	...
	* setAverageTime 
	*
	* untuk set nilai avgTimeInQueue 
	*
	* @param $avg INT akumulasi avgTimeInQueue 
	*/
	...
	* untuk set nilai avgTimeInQueue 
	*
	* @param $total INT akumulasi nilai servc time 
	*/
...
$object = new Queue([5,3,16,5,1,2,3,17,2,5]); # inisialisasi object
$data = $object->execute(); # memanggil method execute yg berada di class queue
?>
